function arrayFunctions(n) {
	console.log("Array : " + n + "<br/>");
	console.log("Reverse the array : " + n.reverse() + "<br/>");
	console.log("Check if some elements greater than 5: " + n.some((x) => x > 5) + "<br/>");
	console.log("Check if every greater than 5: " + n.every((x) => x > 5) + "<br/>");
	console.log("Sum all elements: " + n.reduce((x, y) => x + y) + "<br/>");
	console.log("Sustract the elements starting from the Left: " + n.reduce((x, y) => x - y) + "<br/>");
	console.log("Sustract the elements starting from the Right: " + n.reduceRight((x, y) => x - y) + "<br/><br/>");
}
//Time Complexity - O(n^2) - Quadratic time
function bubbleSortTest(n) {
	let count = 0;
